...
export const HighLight = ({ setIsModalRegisterOpen }: modalRegisterType) => {
    return (
        <>
            <S.SectionHighLight>
                <TitleH1>O sistema que <S.highLightText>descomplica</S.highLightText> a gestão do seu negócio proporcionando eficiência e praticidade em todas as áreas</TitleH1>
